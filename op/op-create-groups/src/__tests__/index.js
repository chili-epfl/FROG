...
test('Create six groups, not enough students', () =>
  expect(operator({ groupnumber: true, globalnum: 6 }, obj)).toEqual({
    group: { '1': ['5'], '2': ['4'], '3': ['3'], '4': ['2'], '5': ['1'] }
  }));

test('Create six groups, enough students', () =>
  expect(operator({ groupnumber: true, globalnum: 6 }, obj2)).toEqual({
    group: {
      '1': ['8'],
      '2': ['7'],
      '3': ['6'],
