...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../node_modules/text-diff-binding/index.js":[function(require,module,exports) {
...
},{}],"../../node_modules/sharedb-string-binding/index.js":[function(require,module,exports) {
...
},{"text-diff-binding":"../../node_modules/text-diff-binding/index.js"}],"../../../../newdot/config/yarn/global/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../../newdot/config/yarn/global/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../../../../newdot/config/yarn/global/node_modules/isarray/index.js":[function(require,module,exports) {
...
},{}],"../../../../newdot/config/yarn/global/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../../../../newdot/config/yarn/global/node_modules/base64-js/index.js","ieee754":"../../../../newdot/config/yarn/global/node_modules/ieee754/index.js","isarray":"../../../../newdot/config/yarn/global/node_modules/isarray/index.js","buffer":"../../../../newdot/config/yarn/global/node_modules/buffer/index.js"}],"../../node_modules/lodash/lodash.js":[function(require,module,exports) {
var global = arguments[3];
...
},{"buffer":"../../../../newdot/config/yarn/global/node_modules/buffer/index.js"}],"../../node_modules/cuid/lib/pad.js":[function(require,module,exports) {
...
},{"./lib/fingerprint.js":"../../node_modules/cuid/lib/fingerprint.browser.js","./lib/pad.js":"../../node_modules/cuid/lib/pad.js"}],"generateReactiveFn.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.generateReactiveFn = exports.Doc = void 0;

var _sharedbStringBinding = _interopRequireDefault(require("sharedb-string-binding"));
...
var cleanPath = function cleanPath(defPath) {
  var rawPath = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var newPath = Array.isArray(rawPath) ? rawPath : [rawPath];
  return [].concat(_toConsumableArray(defPath), _toConsumableArray(newPath));
};

var Doc =
/*#__PURE__*/
function () {
  function Doc(doc, path, readOnly, updateFn) {
    var meta = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
    var backend = arguments.length > 5 ? arguments[5] : undefined;
    var stream = arguments.length > 6 ? arguments[6] : undefined;
    var sessionId = arguments.length > 7 ? arguments[7] : undefined;
    ...
    this.submitOp = readOnly ? function () {
      return updateFn && updateFn();
    } : function (e) {
      doc.submitOp(e);
    };
  ...
  _createClass(Doc, [{
    key: "getMergedPath",
    value: function getMergedPath(path) {
      return cleanPath(this.path, path);
    }
  }, {
    key: "bindTextField",
    value: function bindTextField(ref, rawpath) {
      var path = cleanPath(this.path, rawpath);

      if (typeof (0, _lodash.get)(this.doc.data, path) !== 'string') {
        // eslint-disable-next-line no-console
        console.error("/Users/stian/src/FROG/packages/reactive-tools/generateReactiveFn.js(73:6)", "", "Cannot use bindTextField on path that is not initialized as a string, path: ".concat(JSON.stringify(path), ", value ").concat((0, _lodash.get)(this.doc.data, path), ", doc.data: ").concat(JSON.stringify(this.doc.data), "."));
      }

      var binding = new _sharedbStringBinding.default(ref, this.doc, path);
      binding.setup();
      return binding;
    }
  }, {
    key: "listPrepend",
    value: function listPrepend(newVal, path) {
      this.submitOp({
        p: [].concat(_toConsumableArray(cleanPath(this.path, path)), [0]),
        li: newVal
      });
    }
  }, {
    key: "listAppend",
    value: function listAppend(newVal, path) {
      this.submitOp({
        p: [].concat(_toConsumableArray(cleanPath(this.path, path)), [999999]),
        li: newVal
      });
    }
  }, {
    key: "listInsert",
    value: function listInsert(newVal, path) {
      this.submitOp({
    ...
    key: "listDel",
    value: function listDel(oldVal, path) {
      this.submitOp({
        p: cleanPath(this.path, path),
        ld: oldVal
      });
    ...
    key: "listReplace",
    value: function listReplace(oldVal, newVal, path) {
      this.submitOp({
        p: cleanPath(this.path, path),
        ld: oldVal,
        li: newVal
    ...
    key: "numIncr",
    value: function numIncr(incr, path) {
    ...
    key: "objInsert",
    value: function objInsert(newVal, path) {
      this.submitOp({
        p: cleanPath(this.path, path),
        oi: newVal
      });
    ...
    key: "keyedObjInsert",
    value: function keyedObjInsert(newVal, path) {
      var id = (0, _cuid.default)();
      var aryPath = Array.isArray(path) ? path : [path];
      this.submitOp({
        p: cleanPath(this.path, [].concat(_toConsumableArray(aryPath), [id])),
        oi: _objectSpread({
          id: id
        }, newVal)
      });
    ...
    key: "objDel",
    value: function objDel(oldVal, path) {
      this.submitOp({
        p: cleanPath(this.path, path),
        od: oldVal
      });
    ...
    key: "objReplace",
    value: function objReplace(oldVal, newVal, path) {
      this.submitOp({
        p: cleanPath(this.path, path),
        od: oldVal,
        oi: newVal
    ...
    key: "objSet",
    value: function objSet(newVal, path) {
      this.submitOp({
        p: [].concat(_toConsumableArray(this.path), [path]),
        oi: newVal
      });
    }
  }, {
    key: "specialize",
    value: function specialize(rawPath) {
      var newPath = Array.isArray(rawPath) ? rawPath : [rawPath];
      return new Doc(this.doc, [].concat(_toConsumableArray(this.path), _toConsumableArray(newPath)), this.readOnly, this.updateFn || function (_) {}, this.meta, this.backend);
    }
  }, {
    key: "specializeData",
    value: function specializeData(path, data) {
      if (typeof path === 'string' || typeof path === 'number') {
        return data[[path]];
      } // $FlowFixMe


      return path.reduce(function (acc, x) {
        return acc[[x]];
      }, data);
    }
  }]);
...
var generateReactiveFn = function generateReactiveFn(doc, meta, readOnly, updateFn, backend, stream, sessionId) {
  return new Doc(doc, [], !!readOnly, updateFn, meta, backend, stream, sessionId);
};

exports.generateReactiveFn = generateReactiveFn;
},{"sharedb-string-binding":"../../node_modules/sharedb-string-binding/index.js","lodash":"../../node_modules/lodash/lodash.js","cuid":"../../node_modules/cuid/index.js"}],"../../../../newdot/config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../newdot/config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","generateReactiveFn.js"], null)
//# sourceMappingURL=/generateReactiveFn.js.map