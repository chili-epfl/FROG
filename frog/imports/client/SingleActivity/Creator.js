...
import { createNewLI } from '../Wiki/liDocHelpers';
    ...
    return (
      <Card raised className={classes.card}>
        ...
        <Typography variant="h3" component="h2" className={classes.padded_text}>
          ...
          <a href={'http://localhost:3000/ac/' + url.public}>
            {'http://localhost:3000/ac/' + url.public}
          </a>
        </Typography>
        { /* TODO: Dashboard isn't working yet */ }
...
class Creator extends React.Component<PropsT, StateT> {
  constructor(props) {
    super(props);
    this.state = { stage: 1 };
  }
  ...
  createActivity(config) {
    ...
    this.setState({ liId, stage: this.state.stage + 1 });
  }
...
export default withStyles(style)(Creator);
