  ...
  return (
    <TopBar
      ...
      actions={
          ...
          {(userType=== 'Verified') && (
            <React.Fragment>
            <RowButton onClick = {openPersonalProfileModal} icon = {<Edit/>} > Edit your profile </RowButton>
             <RowButton onClick = {doLogout} icon = {<LockOutlinedIcon/>} > Logout</RowButton>
            </React.Fragment>
            )}
          {(userType=== 'Legacy')&& (
            <React.Fragment>
              <RowButton onClick = {openSignUpModal} onClick = {<LockOutlinedIcon/>} >Upgrade your account </RowButton>
