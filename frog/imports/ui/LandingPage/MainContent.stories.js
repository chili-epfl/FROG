...
import { Delete, Share, Forward, Bookmark, ShowChart, PlayArrow, Create } from '@material-ui/icons';
...
storiesOf('Sessions view', module).add('MainContent', () => (
  <MainContent
    itemList={[ {itemTitle: 'Session 1 ', status: 'Ready'} ,{itemTitle:'Session 2', status: 'Running'}, {itemTitle:'Session 3', status: 'Complete'}]}
    title="My Sessions"
    action="Some action"
    itemIcon = {Bookmark}
...
storiesOf('Drafts view', module).add('MainContent', () => (
  <MainContent
    itemList={[{itemTitle:'Draft 1 '}, {itemTitle: 'Draft 2'},{itemTitle: 'Draft 3'}]}
    title="My drafts"
