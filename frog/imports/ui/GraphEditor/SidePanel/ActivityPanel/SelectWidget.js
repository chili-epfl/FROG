      ...
      <FlexView>
        ...
        <FlexView vAlignContent="center">
          ...
          !valid.social[activity._id].includes(activity.groupingKey)
            ? <p style={{ color: 'red' }}>
                You previously selected the {activity.groupingKey} attribute,
                but no social operator is currently providing that attribute,
                please reconfigure the incoming social operators, or select
                another attribute
              </p>
            : null}
        </FlexView>
