...
import { AccessTimeOutlined, Bookmark, ShowChart, ChromeReaderMode } from '@material-ui/icons';
...
const Wrapper = () => {
   ...
   <>
    ...
    <Panel>
    <RowButton active icon = {<AccessTimeOutlined />} > Recents </RowButton>
...
storiesOf('Recents View ', module).add('recents-page', () => (
    <Wrapper />
  ));
