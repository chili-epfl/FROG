...
(function(e) {
  if (typeof bootstrap === 'function') bootstrap('hark', e);
    ...
    typeof window !== 'undefined' ? (window.hark = e()) : (global.hark = e());
})(() => {
  let define, ses, bootstrap, module, exports;
  return (function(e, t, n) {
    function i(n, s) {
      if (!t[n]) {
        if (!e[n]) {
          const o = typeof require === 'function' && require;
          if (!s && o) return o(n, !0);
          if (r) return r(n, !0);
...
*/
          ...
          WildEmitter.mixin = function(constructor) {
            ...
            prototype.on = function(event, groupName, fn) {
              ...
              let hasGroup = arguments.length === 3,
