    ...
    Object.defineProperty(_assertThisInitialized(_this), "createPeerConnection", {
      ...
      value: function value(remoteUser) {
        try {
          ...
          console.warn("/Users/romainartru/Documents/FROG/ac/ac-webrtc/src/ActivityRunner/index.js(58:6)", 'Cannot create RTCPeerConnection object.');
        }
      }
    });
  ...
  _createClass(ActivityRunner, [{
    ...
    value: function componentDidMount() {
      navigator.mediaDevices.getUserMedia(this.props.activityData.config.sdpConstraints).then(this.gotStream).catch(function (e) {
        console.warn("/Users/romainartru/Documents/FROG/ac/ac-webrtc/src/ActivityRunner/index.js(201:8)", 'Not able to get camera: ', "e", e);
      });
    }
  }, {
