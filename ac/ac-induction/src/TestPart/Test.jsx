...
export default withState('disable', 'setDisable', true)(({
  title,
  disable,
  setDisable,
  properties,
  ...
  return (
    <ExMain>
      ...
      <ExContainer style={{ padding: '20px' }}>
        <ResponsePanel
          {...{ title, examples, properties, tmpList, feedback, data, dataFn, setDisable }}
        />
        <ExButton className="btn btn-default" onClick={clickHandler} disabled={disable}>
          Submit
        </ExButton>
      </ExContainer>
      {feedback && (
