    ...
    exampleData: [
      {
        ...
        config: {
          ...
          trueDef: [],
          falseDef: [],
          imgTrue: 'https://blog.stylingandroid.com/wp-content/themes/lontano-pro/images/no-image-slide.png',
          imgFalse: 'https://blog.stylingandroid.com/wp-content/themes/lontano-pro/images/no-image-slide.png'
        },
        data: []
      },
      {
        ...
        config: {
          title: 'The square :',
          trueDef: ['It has 4 sides', 'It has 4 right angles', 'All of its sides have the same length'],
          falseDef: ['It\'s blue', 'It has no edges'],
          imgTrue: 'http://www.fremontsailingclub.org/sailing/SFlag.gif',
          imgFalse: 'https://www.pharmasystems.com/image/cache/LabelsFall2013/2555-500x500.jpg'
        },
        data: []
      }
    ]
