...
var meta = {
  ...
  description: 'Display a list of images/files possibly categorised, option to allow upload and voting',
  exampleData: [{
    title: 'Simple view',
    config: {
      minVote: 1,
      images: [{
        ...
        url: 'https://wpclipart.com/space/solar_system/sun/solar_eclipse/solar_eclipse_corona.jpg'
      }, {
        url: 'https://wpclipart.com/space/solar_system/sun/sun_prominence.jpg'
      }]
    },
    data: {}
  }, {
    ...
    config: {
      canUpload: true,
      guidelines: 'Ajoutez des images ou bien prenez une photo avec votre webcam'
    },
    data: {}
  }, {
