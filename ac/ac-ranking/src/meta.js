...
const trainConfig = {
  ...
  guidelines:
    '<p>Please drag the items in order.</p><p><img src="/file?name=ac/ac-ranking/form.png" style={{padding: "5" }} width="306" height="146"/><img src="/file?name=/file?name=ac/ac-ranking/graphical.png" border="2" width="306" height="112"/><img src="/file?name=ac/ac-ranking/dragndrop.png" border="2" width="300" height="262"/><img src="/file?name=ac/ac-ranking/command.png" border="2" width="302" height="98"/></p>',
  justify: true,
  mustJustify: true,
